...
const Nav = () => {
    ...
    return (
        <ul className="w-full py-5 bg-white flex justify-around">
            <NavLink
                className={({isActive}) =>
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M7.5 18.3333V10H12.5V18.3333" stroke="#5D6778" stroke-width="1.75" stroke-linecap="round"
            ...
            <NavLink
                ...
                to="/createPost">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.4167 5V15" stroke="#5D6778" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round"/>
                    <path d="M5.41666 10H15.4167" stroke="#5D6778" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round"/>
                </svg>
            </NavLink>
            <NavLink
            ...
            <NavLink
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="#5D6778" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M17.5 17.5L13.875 13.875" stroke="#5D6778" stroke-width="1.75" stroke-linecap="round"
                          stroke-linejoin="round"/>
                </svg>
            </NavLink>
            <NavLink
