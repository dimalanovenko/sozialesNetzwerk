...
const ProfileNav = () => {
    ...
    return (
        <nav
            className="w-1/2 flex justify-around items-center lg:bg-white lg:w-65/100 lg:top-77 lg:right-1/20 lg:h-16.25 lg:absolute lg:shadow-md lg:rounded-b-lg lg:mt-0.25">
            ...
            >
                {({isActive}) =>
                    (
                        <>
                            <svg className='lg:hidden flex cursor-pointer' width="30" height="30" viewBox="0 0 20 21"
                                 fill="none"
                            ...
                            <span className={`${isActive ? "text-[#0C1024]" : "text-[#5D6778]"} hidden lg:flex text-lg font-medium`}>
                                Meine Beiträge
                            </span>
                        </>
                    )
            ...
            <NavLink to="/change_profile">
                {({isActive}) =>
                    (
                        <>
                            <svg
                                className="lg:hidden flex cursor-pointer my-5"
