...
const Feed = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-between bg-[#FAFBFF]">
            <div
                className="w-full flex justify-between items-center text-white fixed bg-white px-2 lg:px-23 py-3 lg:py-5 z-50">
                <div className="flex items-center">
                    <i>
                        ...
                        <svg className='hidden lg:flex lg:mr-3' width="40" height="40" viewBox="0 0 40 40" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
