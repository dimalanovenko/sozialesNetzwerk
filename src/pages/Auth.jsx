...
import {loginSuccess, startLoading, stopLoading} from "../features/authSlice.js";
        ...
        (
            <section className="flex flex-col items-center justify-center text-white gap-3 h-[100vh]">
                ...
                <button
                    ...
                    {isSignUp ?
                        <p className='cursor-pointer'>Haben Sie schon ein Konto? <span
                            className='font-bold'>Anmelden</span>
                        </p> :
                        <p className='cursor-pointer'>Haben Sie noch kein Konto? <span
                            className='font-bold'>Registrieren</span></p>
                    }
                </button>
            </section>
        )
